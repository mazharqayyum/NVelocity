...
namespace NVelocity.Test
{
	...
	[TestFixture]
	public class ExtensionMethodCallTestCase
	{
	...
	{
		public static string JustDoIt(this NVelocity.Test.ExtensionMethodCallTestCase.TestClass that, double obj)
		{
			return Convert.ToString(obj, CultureInfo.InvariantCulture);
		}

		public static string JustDoIt(this NVelocity.Test.ExtensionMethodCallTestCase.TestClass that, object obj)
		{
			return Convert.ToString(obj, CultureInfo.InvariantCulture);
		}

		public static string Amb(this NVelocity.Test.ExtensionMethodCallTestCase.TestClass that, object obj)
		{
			return obj.GetType().Name;
		}

		public static string Amb(this NVelocity.Test.ExtensionMethodCallTestCase.TestClass that, IDictionary obj)
		{
			return obj.GetType().Name;
		}

		public static string ThrowException(this NVelocity.Test.ExtensionMethodCallTestCase.TestClass that)
		{
